...
### 2022.11.25  
#### 结果：
- 1、激光雷达与相机标定工作：使用了香港大学开源框架lidar_camera_calib，但是使用过程中发现bug，使用gdb逐行调试，发现是pcl库中的点云分割器中的一个函数出现内存溢出的错误，猜测是由于pcl、vtk版本等问题。（已解决）    遂使用了点对点的标定方法，完成标定。
- 2、r3live数据集复现完成 
- 3、fastlio复现完成
...
- 4、fastlio复现完成
    ...
    [![Watch the video]([https://github.com/ZJUT-IoCS-MAS/lcw/blob/38ff197589da001a084fc718dadbac5820944d57/image/r3live.png])]([http://youtu.be/vt5fpE0bzSY](https://github.com/ZJUT-IoCS-MAS/lcw/blob/38ff197589da001a084fc718dadbac5820944d57/image/r3live.mp4))
    </div>
